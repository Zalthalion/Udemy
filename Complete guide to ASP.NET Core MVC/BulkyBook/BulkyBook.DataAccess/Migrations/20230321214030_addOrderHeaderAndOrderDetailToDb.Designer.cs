...
namespace BulkyBook.Web.Migrations
{
    ...
    [Migration("20230321214030_addOrderHeaderAndOrderDetailToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BulkyBook.Models.OrderHeader", b =>
                {
                    ...
                    b.Property<string>("PaymentStatuss")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BulkyBook.Models.OrderHeader", b =>
                {
                    b.HasOne("BulkyBook.Models.ApplicationUser", "AplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BulkyBook.Models.Product", b =>
                {
                    ...
                    b.HasOne("BulkyBook.Models.Cover", "Cover")
                        .WithMany()
